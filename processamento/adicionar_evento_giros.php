...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["titulo"]) && isset($_FILES["imagem"]) && isset($_FILES["banner"])) {
        $titulo = $_POST["titulo"];
        ...
        try {
            ...
            $conn->exec("DELETE FROM eventos_giros");

            // Query SQL para inserir o evento no banco de dados
            $sql = "INSERT INTO eventos_giros (titulo, imagem, banner) VALUES (:titulo, :imagem, :banner)";
            ...
            exit(); // Adiciona exit() para interromper a execução após o redirecionamento
