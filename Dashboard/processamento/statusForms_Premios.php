...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $idEvento = isset($_POST['eventoId1']) ? intval($_POST['eventoId1']) : null;
        ...
        $queryStatus = "SELECT interative FROM eventos_premiacao WHERE id = :idEvento LIMIT 1";
        ...
        $queryAtualiza = "UPDATE eventos_premiacao SET interative = :novoStatusEvento WHERE id = :idEvento";
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['eventoId1'])) {
        $idEvento = intval($_GET['eventoId1']);
